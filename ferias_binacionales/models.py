...
class ConstanciaEstudios(models.Model):
    ...
    fotografia = models.BooleanField(verbose_name="Fotografia reciente",default=False)
...
class DefensoriaPublica(models.Model):
    ...
    ap_paterno = models.CharField(verbose_name="Apellido Paterno", max_length=50)
    ap_materno = models.CharField(verbose_name="Apelldio Materno", max_length=50)
    tramite_realizar = models.CharField(verbose_name="Tramite a Realizar", max_length=80)
...
class LicenciaConducir(models.Model):
    ...
    fotografia = models.BooleanField(verbose_name="Fotografia",default=False)
...
class ExpedicionActa(models.Model):
    ...
    ap_paterno = models.CharField(verbose_name="Apellido Paterno", max_length=50)
    ap_materno = models.CharField(verbose_name="Apelldio Materno", max_length=50)
    nombre_solicitante = models.CharField(verbose_name="Nombre solicitante", max_length=100)
