...
class PersonaDesaparecidaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        widgets = {
                'curp':forms.TextInput(attrs={'class':'form-control','placeholder':'CURP','onFocus':'validar(this)'}),
                ...
                'ultimo_lugar':forms.TextInput(attrs={'class':'form-control','placeholder':'Última lugar dónde se sabe al desaparecido(a)'}),
