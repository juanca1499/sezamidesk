...
class EmpleadoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('first_name','last_name','segundo_apellido','alias','telefono','username','password')
        ...
        widgets = {
            ...
            'segundo_apellido':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Segndo apellido','onFocus':'validar(this)'}),
